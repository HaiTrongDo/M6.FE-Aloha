    ...
    return (
        <div>
            <div id="defaultModal" tabIndex="-1" aria-hidden="true"
                 className="  fixed  top-[75px] right-0 left-[555px] z-50 w-[730px]  h-modal md:h-full ">
                <div className="  p-4 w-full max-w-2xl h-full md:h-auto">
                    <div className="  bg-white rounded-lg shadow dark:bg-gray-700">
                        ...
                        <div
                            ...
                            <button onClick={handleCloseDialogWallet} data-modal-toggle="defaultModal" type="button"
