        ...
        <div>
            <TransactionsLayout>
                ...
                <div className="flex justify-center gap-2">
                                        ...
                                        <div key={index}>
                                            ...
                                            <li className={!toggleDetail ? active : active + " " + "bg-emerald-50"}
                                                ...
                                                <div className="flex items-center space-x-4">
                                                    ...
                                                    <div
                                                        className={transaction.category.type === 'EXPENSE'
                                                            ? 'inline-flex items-center text-base text-red-600'
                                                            : 'inline-flex items-center text-base text-blue-600 '}
                                                    >
                                                        {transaction.category.type === 'EXPENSE'
                                                            ? "-" + transaction.amount
                                                            : "+" + transaction.amount}
                    ...
                    {/*detail transaction*/}
                    {toggleDetail &&
                        <div className=" master-container flex h-[280px] w-[60%] rounded-5">
                            <div className="bg-white w-full ">
                                <div className="flex justify-between items-start p-5 border-0 rounded-t border-b-2">
                                    ...
                                    <div className="">
                                        ...
                                        <Button sx={{color: '#2EB74B'}}>EDIT</Button>
                                    </div>
                                </div>
                                ...
                                <div>
                                    <div className="grid grid-cols-6 mt-3">
                                        <div className="">
                                            <img src="https://static.moneylover.me/img/icon/ic_category_foodndrink.png"
                                                 alt=""
                                    ...
                                    <div className="grid grid-cols-6">
                                        <div></div>
                                        <div
                                            className={detail.category.type === 'EXPENSE'
                                                ? 'text-3xl text-red-600 mt-4 col-span-5'
                                                : 'text-3xl text-blue-600 mt-4 col-span-5'}
                                        >
                                            {detail.category.type === 'EXPENSE'
                                                ? '-' + detail.amount
                                                : '+' + detail.amount}
                                        </div>
                                    </div>
