    ...
    return (
        ...
        >
            ...
            <div className="main-wrapper">
                <main className="mainPageWrapper_z5dv">
                    <div className="container md:pt-20 pb:12 lg:mb-24 md:h-full">
                        <div className="md:px-14 lg:px-44"><h1
                            className="font-ibm tracking-tight lg:text-64 lg:leading-83 font-medium text-36 md:text-64 text-green-ml leading-52 md:leading-83 mb-1 text-center">Simple
                            way</h1><p
                            className="font-ibm text-36 text-dark-brown leading-48 md:leading-56 md:text-40 text-center"/>
                            <h1 className="font-ibm tracking-tight lg:text-64 lg:leading-83 text-dark-brown font-light text-36 leading-48 md:inline">to
                                manage </h1><h1
                                className="font-ibm tracking-tight lg:text-64 lg:leading-83 font-medium text-36 leading-48 md:inline text-green-ml">personal
                                finances</h1><p/>
                            <div
                            ...
                            <div
                                ...
                                <div className="grid grid-cols-2 gap-2 mx-4 my-4"><a href="https://web.moneylover.me"
                                                                                     target="_blank"
                                                                                     rel="noopener noreferrer"
                                                                                     className="button-ml text-16 md:w-full"
                                                                                     style={{textDecoration: 'none'}}>Try
                                    on browser</a><a href="#cta"
                                                     className="button-ml-primary bg-green-ml text-16 md:w-full"
                                                     style={{textDecoration: 'none'}}>Download for free</a></div>
                            </div>
                        </div>
                    ...
                    <section className="container mt-14 lg:mt-44"><h2
                    ...
                    <section className="container mt-14 lg:mt-44">
                        ...
                        <div className="slick-slider slick-initialized">
                            <div className="slick-list">
                                <div className="slick-track flex items-center"
                                     style={{width: '918px', opacity: 1, transform: 'translate3d(0px, 0px, 0px)'}}>
                                    <div data-index={0} className="slick-slide slick-active slick-center slick-current"
                                         tabIndex={-1} aria-hidden="false" style={{outline: 'none', width: '306px'}}>
                                        <div>
                                            <div
                                                ...
                                                className="text-dark-brown lg:h-screen">Perfect app. My husband and I
                                                use it to track all our expenses and income. We generate our household
                                                accounts and budget using this fab app. Furthermore, the developers are
                                                hands-on and extremely helpful. Do not look any further. Get this app
                                                now!.</p><p className="pt-4 font-bold leading-20">Lorna Mifsud
                                                Cachia</p></div>
                                        </div>
                                    </div>
                                    <div data-index={1} className="slick-slide slick-active" tabIndex={-1}
                                        ...
                                        <div>
                                            <div
                                                className="review-slide lg:h-screen grid grid-rows-6 px-4 py-6 lg:p-6 text-center"
                                                tabIndex={-1} style={{width: '100%', display: 'inline-block'}}><p
                                                className="text-dark-brown lg:h-screen">This will keep you organized and
                                                ...
                                                dollar.</p><p className="pt-4 font-bold leading-20">Minh &amp; Tam</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div data-index={2} className="slick-slide" tabIndex={-1} aria-hidden="true"
                                        ...
                                        <div>
                                            <div
                                                className="review-slide lg:h-screen grid grid-rows-6 px-4 py-6 lg:p-6 text-center"
                                                tabIndex={-1} style={{width: '100%', display: 'inline-block'}}><p
                                                className="text-dark-brown lg:h-screen">A simple, accessible app that
                                                allows you to budget across weeks, months and years. The neat financial
                                                calendar lets you set up alerts and keep tabs on all transactions. Plus,
                                                it works with all currencies.</p><p
                                                className="pt-4 font-bold leading-20">Jeveny Johnson</p></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="relative grid grid-cols-12 bg-green-ml py-12 lg:py-20 rounded-2xl">
                            <div className="col-span-12 col-start-1 lg:col-start-3 lg:col-end-8"><p
                                ...
                                <div className="flex justify-center lg:justify-start w-full"><a
                                    ...
                                    src="http://moneylover.me/img/marketplace/appstore.svg" alt=""/></a><a
                                    ...
                                    src="http://moneylover.me/img/marketplace/google-play.svg" alt=""/></a></div>
                            </div>
                            <img className="invisible w-1/5 lg:visible absolute bottom-0 lg:left-2/3"
                                 src="http://moneylover.me/img/MOCKUP@4x.png" alt=""/></div>
                    </section>
                </main>
            </div>
            <footer className="lg:py-6 lg:m-0 mt-10 border-t border-monochrome-medium-tint">
                <section className="container grid grid-cols-1 lg:grid-cols-12 gap-y-8 lg:gap-x-8 lg:mx-auto"><p
                    className="flex items-center mt-6 lg:mt-0 lg:col-span-6 text-16 leading-24 text-dark-brown">© 2022
                    Finsify Technology Co., Ltd. All rights reserved.</p>
                    <div className="flex flex-col lg:flex-row justify-center gap-y-4 lg:col-span-5 lg:gap-x-4"><a
