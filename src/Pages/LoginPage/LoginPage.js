                    ...
                    <form>
                        ...
                        <div className="social-container">
                            <Link to="" onClick={() => signInWithFireBase(auth, faceBookAuthProvider)}
                                  className="social hover:text-blue-500"><i className="fab fa-facebook-f"/></Link>
                            <Link to="" onClick={() => signInWithFireBase(auth, googleAuthProvider)} className="social hover:text-red-500"><i
                                className="fab fa-google-plus-g"/></Link>
                            <Link to="" onClick={() => signInWithFireBase(auth, githubAuthProvider)} className="social hover:text-black"><i
                ...
                <div className="form-container sign-in-container">
                    <form>
                        ...
                        <div className="social-container">
                            <Link to="" onClick={() => signInWithFireBase(auth, faceBookAuthProvider)}
                                  className="social hover:text-blue-500"><i className="fab fa-facebook-f"/></Link>
                            <Link to="" onClick={() => signInWithFireBase(auth, googleAuthProvider)} className="social social hover:text-red-500"><i
                                className="fab fa-google-plus-g"/></Link>
                        ...
                        <div className={"w-full relative "}>
                            ...
                            <div onClick={handleChangeTypePassword}
                                ...
                                {togglePassword ? <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
